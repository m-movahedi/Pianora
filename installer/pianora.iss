#define MyAppName "Pianora Piano tranier"
#define MyAppExeName "pianora.exe"
...
[Setup]
; Never change AppId: it is how a newer installer finds and upgrades Pianora.
...
DefaultDirName={localappdata}\Programs\Pianora
DefaultGroupName={#MyAppName}
DisableProgramGroupPage=yes
PrivilegesRequired=lowest
OutputDir=output
OutputBaseFilename=Pianora-Piano-tranier-Setup-{#MyPackageVersion}
